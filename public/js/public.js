...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const showImage = (index) => {
        ...
        nextBtn.style.display = (currentIndex === allImages.length - 1) ? 'none' : 'block';
    };
    ...
    if (mainImage) {
        ...
        mainImage.addEventListener('click', () => {
            ...
            const startIndex = allImages.findIndex(src => src.endsWith(new URL(currentImageSrc).pathname));
